...
import {AiImageAsset, Asset, AssetState, StockImageAsset, StockVideoAsset, VoiceoverAsset} from '../revideo/scene';
...
export async function downloadPixabayImage({prompt, orientation}: StockImageAsset["instructions"]
